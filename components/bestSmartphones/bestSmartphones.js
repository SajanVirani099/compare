    ...
    return (
        <div className="max-w-[1280px] w-full mx-auto my-6 sm:my-8 px-4 sm:px-6 md:px-8 lg:px-0 border-[#d1d9e6] border-2 rounded-lg">
            ...
            <div className="relative w-full overflow-hidden shadow-inset">
                <div
                    ref={scrollRef}
                    className="flex gap-4 sm:gap-5 md:gap-6 overflow-x-auto scroll-smooth scrollbar-hide py-2 px-2"
                        ...
                        return (
                            ...
                            >
                                ...
                                <Link
                                    ...
                                    className="block rounded-xl bg-[#E6E7EE] shadow-[3px_3px_6px_#d1d9e6,-3px_-3px_6px_#ffffff] p-2 hover:shadow-[4px_4px_8px_#d1d9e6,-4px_-4px_8px_#ffffff] transition-all duration-200"
                                >
                                    {/* Product Image */}
                                    <div className="w-full flex items-center justify-center mb-2">
                                        <div className="w-32 h-32 sm:w-36 sm:h-36 md:w-40 md:h-40 rounded-lg bg-white shadow-[inset_2px_2px_4px_#d1d9e6,inset_-2px_-2px_4px_#ffffff] p-1.5 sm:p-2 flex items-center justify-center overflow-hidden">
                                            <img
                                                src={productImage}
                                                alt={productName}
